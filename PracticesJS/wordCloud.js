 let str=  "We came, we saw, we conquered...then we ate Bill's (Mille-Feuille) cake.";
...
//     worldLength++;
//   } else {
//     const word =str.slice(startIndex, startIndex+worldLength)
//     words.push(word);
//     worldLength=0;
//   }
// }
...
const wordCount = new WordCloudData(str);
